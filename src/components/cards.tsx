...
export function Card({ type, index, id, selectedCard, setSelectedCard }: { type: boolean; index: number; id: string; selectedCard: string | null; setSelectedCard: (id: string | null) => void }) {
  let cardPic;
  if (!type) {
